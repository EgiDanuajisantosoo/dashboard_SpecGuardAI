            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="col-span-1 flex flex-col gap-6">
                    ...
                    <div class="bg-[#161616] border border-[#2A2A2A] rounded-lg p-5 flex-1">
                        ...
                        <div class="space-y-3">
                            <a href="#" class="block p-3 rounded border border-[#333] hover:border-gray-500 hover:bg-[#1C1C1C] transition-all group">
                                <div class="flex items-start justify-between mb-1">
                                    <h4 class="text-sm text-gray-300 font-medium group-hover:text-white">Payment Gateway Spec</h4>
                                    <span class="text-[10px] text-gray-500">2d ago</span>
                                </div>
                                <div class="flex items-center gap-2 mt-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                                    <span class="text-xs text-gray-500">Auditing Active</span>
                                </div>
                            </a>
                            <a href="#" class="block p-3 rounded border border-[#333] hover:border-gray-500 hover:bg-[#1C1C1C] transition-all group">
                                <div class="flex items-start justify-between mb-1">
                                    <h4 class="text-sm text-gray-300 font-medium group-hover:text-white">User Profile RFC</h4>
                                    <span class="text-[10px] text-gray-500">5d ago</span>
                                </div>
                                <div class="flex items-center gap-2 mt-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                                    <span class="text-xs text-gray-500">Auditing Active</span>
