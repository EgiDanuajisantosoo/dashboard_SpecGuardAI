...
Sistem SHALL menyediakan view `/` (sebagai dashboard PRD input) yang memungkinkan pengguna mengirim PRD, dan memisahkan tampilan visual Mermaid.js ke halaman khusus Live Audit Board (`/compliance`) serta OpenSpec editor ke halaman `/openspec`.
